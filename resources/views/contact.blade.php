...
@section('title', 'Contact Us - HealthSync')
...
<div class="bg-gray-50 min-h-screen py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="text-center mb-10">
            ...
            <p class="mt-4 text-lg text-gray-500">Have questions or need support? We're here to help.</p>
        </div>
                            ...
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input type="text" name="name" id="name" 
                                        class="pl-10 block w-full rounded-md border-0 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-primary-600 sm:text-sm" 
                            ...
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    <textarea id="message" name="message" rows="5" 
                                        class="block w-full rounded-md border-0 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-primary-600 sm:text-sm" 
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    <p class="text-md font-medium text-gray-900">Email Support</p>
                                    <p class="mt-2 text-base text-gray-600">support@healthsync.com</p>
