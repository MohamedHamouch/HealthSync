...
@section('title', 'Inactive Doctors - HealthSync Admin')
    ...
    <div class="w-64 bg-primary-800 text-white shadow-lg hidden md:block">
        ...
        <nav class="mt-6">
            <ul>
                ...
                <li class="py-2">
                    <a href="{{ route('admin.doctors.inactive') }}" class="flex items-center px-6 py-2 bg-primary-900 text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex-1">
        ...
        <div id="mobile-menu" class="md:hidden hidden bg-primary-800 text-white">
            <nav class="px-4 py-2">
                <ul>
                    ...
                    <li class="py-2">
                        <a href="{{ route('admin.doctors.inactive') }}" class="flex items-center py-2 bg-primary-900">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                            Inactive Doctors
        ...
        <div class="p-6">
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">Inactive Doctors</h1>
                    <p class="text-gray-600 mt-1">Review and activate doctor accounts</p>
                </div>
                <div class="mt-4 md:mt-0">
                    <form action="{{ route('admin.doctors.inactive') }}" method="GET" class="flex">
                        <div class="flex">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded-full object-cover" src="{{ $user->avatar_url }}" alt="{{ $user->first_name }} {{ $user->last_name }}">
                                        </div>
                                        <div class="ml-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    <a href="{{ route('admin.users.activate', $user->id) }}" class="text-green-600 hover:text-green-900" onclick="return confirm('Are you sure you want to activate this doctor?')">
                                        Activate
                                    </a>
                                </td>
                            </tr>
