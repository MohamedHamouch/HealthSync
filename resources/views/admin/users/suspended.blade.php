...
@section('title', 'Suspended Users - HealthSync Admin')
    ...
    <div class="w-64 bg-primary-800 text-white shadow-lg hidden md:block">
        ...
        <nav class="mt-6">
            <ul>
                ...
                <li class="py-2">
                    <a href="{{ route('admin.users.suspended') }}" class="flex items-center px-6 py-2 bg-primary-900 text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex-1 overflow-x-hidden overflow-y-auto">
        ...
        <div id="mobile-menu" class="md:hidden hidden bg-primary-800 text-white">
            <nav class="px-4 py-2">
                <ul>
                    ...
                    <li class="py-2">
                        <a href="{{ route('admin.users.suspended') }}" class="flex items-center py-2 font-semibold">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
                            </svg>
                            Suspended Users
        ...
        <div class="p-6">
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">Suspended Users</h1>
                    <p class="text-gray-600 mt-1">Manage suspended user accounts</p>
                </div>
                <div class="mt-4 md:mt-0">
                    <form action="{{ route('admin.users.suspended') }}" method="GET" class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2">
                        <div class="flex">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    <a href="{{ route('admin.users.unsuspend', $user->id) }}" class="text-green-600 hover:text-green-900" onclick="return confirm('Are you sure you want to unsuspend this user?')">
                                        Unsuspend
                                    </a>
                                </td>
                            </tr>
