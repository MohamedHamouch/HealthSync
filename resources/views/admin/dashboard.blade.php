...
@section('title', 'Admin Dashboard - HealthSync')
...
<div class="flex min-h-screen bg-gray-50">
    ...
    <div class="w-64 bg-primary-800 text-white shadow-lg hidden md:block">
        ...
        <nav class="mt-6">
            <ul>
                <li class="py-2">
                    <a href="{{ route('dashboard') }}" class="flex items-center px-6 py-2 bg-primary-900 text-white">
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <h2 class="text-2xl font-bold text-gray-800">{{ $dashboardData['totalUsers'] }}</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <h2 class="text-2xl font-bold text-gray-800">{{ $dashboardData['totalClients'] }}</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-indigo-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <h2 class="text-2xl font-bold text-gray-800">{{ $dashboardData['totalDoctors'] }}</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-gray-500 text-sm">Inactive Doctors</p>
                            <h2 class="text-2xl font-bold text-gray-800">{{ $dashboardData['inactiveDoctors'] }}</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-red-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <h2 class="text-2xl font-bold text-gray-800">{{ \App\Models\User::where('is_suspended', true)->count() }}</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden mb-8">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="{{ route('admin.users.index') }}" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">View and manage active users</p>
                            </div>
                        </a>

                        <a href="{{ route('admin.users.suspended') }}" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            ...
                            <div>
                                <h4 class="font-medium text-gray-800">Suspended Users</h4>
                                <p class="text-sm text-gray-500">Manage suspended accounts</p>
                            </div>
                        </a>

                        <a href="{{ route('admin.doctors.inactive') }}" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            ...
                            <div>
                                <h4 class="font-medium text-gray-800">Inactive Doctors</h4>
                                <p class="text-sm text-gray-500">Manage inactive doctors</p>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 flex justify-between items-center">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="text-xs text-white hover:text-blue-100 flex items-center">
                        <span>View All</span>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($dashboardData['recentUsers'] as $user)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('admin.users.show', $user->id) }}" class="text-primary-600 hover:text-primary-900 mr-3">View</a>
                                        @if($user->is_suspended)
                                            <a href="{{ route('admin.users.unsuspend', $user->id) }}" class="text-green-600 hover:text-green-900">Unsuspend</a>
                                        @else
                                            <a href="{{ route('admin.users.suspend', $user->id) }}" class="text-red-600 hover:text-red-900">Suspend</a>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
